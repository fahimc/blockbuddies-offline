...
HUD, buddy messages, inventory, avatar editing, and settings. The Three.js scene owns the
...
- `src/ui` - menus, HUD, buddy messages, shop, avatar editor, settings, mobile controls.
...
The game is intentionally offline. Bot messages, schedules, quests, memory, and saves
